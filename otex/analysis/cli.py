...
Examples::
    ...
    otex-uncertainty --T_WW 28 --T_CW 5 --method monte-carlo --samples 1000

    # Sobol sensitivity analysis
    otex-uncertainty --T_WW 28 --T_CW 5 --method sobol --samples 512

    # Tornado diagram analysis
    otex-uncertainty --T_WW 28 --T_CW 5 --method tornado

    # Full analysis (all methods)
    otex-uncertainty --T_WW 28 --T_CW 5 --method all --samples 500
"""
...
def main():
    """CLI entry point for ``otex-uncertainty`` command."""
    parser = argparse.ArgumentParser(
        description='OTEX Uncertainty Analysis - Monte Carlo, Sobol, and Tornado analysis',
...
Examples:
  ...
  otex-uncertainty --T_WW 28 --T_CW 5 --method sobol --samples 512
  otex-uncertainty --T_WW 28 --T_CW 5 --method tornado
  otex-uncertainty --T_WW 28 --T_CW 5 --method all --samples 500 --save-plots
        '''
    )
    ...
    if args.method in ('sobol', 'all'):
        ...
        try:
            ...
            print("Install with: pip install otex[uncertainty]")
